...
class Image
{
   ...
   protected function __construct($img, $corner, $wid, $hei,$c, $corner_radius, $angle){
       $this->srcimg = $img;
       $this->corner = $corner;
   ...
   //处理圆角
   protected function rounded_corner($image,$size)
   {
                $topleft = true;
                $bottomleft = true;
                $bottomright = true;
...
$image = new Image($img_file, $corner, "80", "80", "1", "6", "0");
?>
